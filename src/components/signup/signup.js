...
const SignupCard = ({ onCloseSignupCard, onSwitchToLogin }) => {
    ...
    <div className="signup-card">
      <div className="signup-sections-container">
        <div className="icon-section">
          ...
          <TypingText text="Welcome! Ready to join us? 🤩" className='icon3' />
        ...
        <div className="signup-section">
          <div className="signup-section-div">
            <img src="./logo.png" alt="Signup" width={"70px"} height={"20px"} className='logoimggg' />
            <button className='signup-close-btn' onClick={onCloseSignupCard}>
                        <IoClose />
                    </button>
            <div>
              <h2 className='signup-section-h1'>Sign Up</h2>
              <p className='signup-section-p'>Create a new account.</p>
              <form>
                ...
                <div className="signup-form-group">
                  ...
                  <input className='signup-inputs' type="text" id="number" name="number" placeholder='Enter your phone number' />
                </div>
                <div className="signup-form-group">
                ...
                <p className='signup-section-prp'>or</p>
              </form>
              <div className="signup-social-login">
                <button className="signup-social-login-button signup-google-login">
                  <FcGoogle className='signup-giocn' /> 
                </button>
                <button className="signup-social-login-button signup-apple-login">
                  <FaApple className='signup-giocn' />
                </button>
              </div>
            
              <p className='login-section-pp'>Already have an account? <span onClick={onSwitchToLogin}>Login</span></p>
              <p className='login-section-ppy'><b>Are you a provider?</b> <button className='btmn' >signup Here</button></p>
